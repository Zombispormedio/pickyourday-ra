...
function createDetector(dimensions){
    canvas_ar=document.createElement('canvas');
    
     canvas_ar.width = dimensions.width;
        canvas_ar.height = dimensions.height;
      context_detector = canvas_ar.getContext('2d');
    
        detector=createAR(canvas_ar);
}



     var createAR = function(sourceCanvas) {
